...
config :flagex,
  ecto_repos: [Flagex.Repo]

# Configures the endpoint
config :flagex, FlagexWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: FlagexWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Flagex.PubSub,
  live_view: [signing_salt: "i4ErRL9C"]
...
config :flagex, Flagex.Mailer, adapter: Swoosh.Adapters.Local
